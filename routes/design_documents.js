...
var partesusadas=function(doc){if(doc.parteusada_name){emit(doc._id,{_id:doc_id,parteusada_name:doc.parteusada_name});}}

{
   "_id": "_design/partesusadas",
   "views": {
       "all": {
           "map": "function(doc){if(doc.parteusada_name){emit(doc._id, {_id:doc._id, parteusada_name:doc.parteusada_name});}};"
       }
   }
}
